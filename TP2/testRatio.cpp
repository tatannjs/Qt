...
int main()
{
     cout << "Vous devez comparer le programme source et son affichage pour vérifier que vous comprennez bien toutes les opérations." << endl
          << endl;
     ...
     cout << "r2=";
     r2.ecrire();
     cout << ", numérateur de r2 = " << r2.numerateur() << ", denominateur de r2 = " << r2.denominateur() << endl;
          ...
          << "17: Opérateurs de pré et post incrémentation et décrémentation :" << endl;
     {
          ...
          cout << endl
               << "Les opérateurs suivants n'utilisent pas de variable locale, " << endl
